...
class DataReply(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('DataReply')
...
class DataRequest(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('DataRequest')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(DataReply)
DataReply.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'a', None, None, ),  # 1
    (2, TType.DOUBLE, 'b', None, None, ),  # 2
)
all_structs.append(DataRequest)
DataRequest.thrift_spec = (
    None,  # 0
